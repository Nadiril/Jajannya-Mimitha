              ...
              <div className='p-8 sm:p-10 lg:p-14'>
                ...
                <div className='mt-8 flex flex-col gap-3 sm:flex-row'>
                  <a 
                    ...
                    className='inline-flex items-center justify-center gap-2 rounded-full border border-white/30 bg-white px-6 py-3 text-sm font-bold text-mimitha-primary'
                  >
                  ...
                  <a 
                    ...
                    target='_blank' 
                    rel='noopener noreferrer' 
                    className='inline-flex items-center justify-center rounded-full border border-white/30 bg-transparent px-6 py-3 text-sm font-bold text-white'
                  >
                    Buka Google Maps
                  </a>
                </div>
