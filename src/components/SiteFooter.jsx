...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/jajannyamimitha?igsh=NHE2dXlwM21hemQy',
    icon: (
            ...
            <div className='flex flex-wrap gap-3'>
              {socialLinks.map((social) => (
                <a
                  ...
                  className='inline-flex items-center gap-2 rounded-full border border-mimitha-primary/15 px-4 py-2 text-sm font-semibold text-mimitha-primary transition hover:bg-mimitha-primary hover:text-white'
                >
                  {social.icon}
                  {social.name}
                </a>
