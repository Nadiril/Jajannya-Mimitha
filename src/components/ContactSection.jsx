        ...
        <div className="overflow-hidden rounded-[2.5rem] bg-mimitha-primary text-white shadow-2xl shadow-mimitha-primary/20">
          <div className="grid lg:grid-cols-[1fr_1fr]">
            <div className="p-8 sm:p-10 lg:p-14">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-[1.5rem] bg-white/10 p-5">
                  ...
                  <p className="mt-2 font-bold">+62 83848922906</p>
                </div>
                <div className="rounded-[1.5rem] bg-white/10 p-5">
            ...
            <div className="relative min-h-[500px] bg-mimitha-primary">
              <div className="flex h-full flex-col p-8 sm:p-10 lg:p-14">
                <div>
                ...
                <div className="mt-4 relative h-[420px] overflow-hidden rounded-[1.5rem] bg-mimitha-cream">
                  <InteractiveMap />
                </div>
              </div>
            </div>
